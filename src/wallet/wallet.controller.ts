import { Controller, Post, Get, Body, Param, ParseIntPipe, UseGuards, Req, Query } from '@nestjs/common';
...
export class WalletController {
  ...
  @Post('send')   //wallet/send
  async sendMoney(@Body() userId:number, sendMoneyDto: SendMoneyDto) {
