...
export class PaymentController {
  ...
  async initiatePayment(
    @Body() body: { firstName: string; lastName: string; email: string; phoneNumber: string; amount: number ; userId : string }
    ...
    try {
      ...
      const paymentPayload = {
        ...
        email: body.email,
        orderId: body.userId,
        webhook: "https://c27c-102-159-200-245.ngrok-free.app/payments/notification_payment",
        silentWebhook: true,
